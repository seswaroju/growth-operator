...
| MVP-045 | Catalog migration + CRUD | ✅ | 2026-07-31 | _uncommitted_ | Migration `d2cecc53f63c` (012: catalog_items+history+idempotency, RLS, GIN+HNSW, pgvector); `crud.py` create/get/list-cursor/update-ifmatch/soft-delete + history + identity dedup + Idempotency-Key; `POST/GET/PATCH/DELETE /v1/catalog/items`; **307 pytest** (unblocks 042) |
