...
| MVP-046 | Attributes validation (JSON Schema + CEL) | ✅ | 2026-07-31 | _uncommitted_ | `validate.py` Draft-2020-12 (+additionalProperties) + CEL constraints → `{path,error,rule}`, cached per (pack,ver); wired into CRUD → 422; **315 pytest** |
