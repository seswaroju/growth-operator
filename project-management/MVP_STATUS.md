...
| MVP-047 | Text search (BM25) | ✅ | 2026-07-31 | `ab07642` | `search.py` search_text tsvector (simple⊕english) from title/desc/x-search projection, maintained on write; `ts_rank` BM25 over GIN; `GET /v1/catalog/search`; **318 pytest** |
