...
| MVP-036 | Suppression + consent | ✅ | 2026-07-30 | _uncommitted_ | Enforcement gate in MVP-034 + `keywords.py` STOP/UNSUB net (en/hi/te) → normalizer auto-suppress (marketing, idempotent) + founder-approved transactional confirm (DECISIONS 2026-07-30); **206 pytest**. Suppressed badge deferred to chats page (MVP-087) |
