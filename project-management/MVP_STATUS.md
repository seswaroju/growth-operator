...
| MVP-050 | Pricing migration + rules_v1 engine | ✅ | 2026-08-02 | _uncommitted_ | Migration `63bcec3ea528` (013 pricing tables +RLS); safe-AST Decimal engine (round/rate/tax_rule/sum/min/max/map/item/offer, residue fail-closed, provenance, stale_rate) + registry; **both packs' goldens pass on one engine**; **351 pytest** |
