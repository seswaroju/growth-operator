...
| MVP-038 | Pack contract models | ✅ | 2026-07-31 | _uncommitted_ | `core/packs/contracts.py` typed L0↔L1 contracts (manifest+slots, bindings, catalog, pricing, workflow, integration + aux); strict/open split; every verticals/* file parses + path-precise negatives; **266 pytest** |
